        ...
        $C = [
            ...
            'brief' => [
                'en' => ['brief' => 3, 'briefing' => 3, 'morning brief' => 4, 'update me' => 3, 'catch me up' => 3,
                         ...
                         'give me the rundown' => 3, 'daily report' => 3, 'todays report' => 3],
                'bn' => ['ব্রিফ' => 4, 'আজকের ব্রিফ' => 5, 'সারসংক্ষেপ' => 3, 'সার্বিক অবস্থা' => 4, 'খবর কি' => 3,
                         'অবস্থা কি' => 3, 'আজকের অবস্থা' => 4, 'সংক্ষেপে বলো' => 3, 'আপডেট দাও' => 3, 'পরিস্থিতি' => 2],
            ...
            'focus' => [
                'en' => ['what should i focus' => 5, 'what should i do' => 4, 'priority' => 3, 'priorities' => 3,
                         ...
                         'what is urgent' => 4, 'top priority' => 4],
                'bn' => ['কি করা উচিত' => 5, 'করা উচিত' => 5, 'কোনটা আগে' => 4, 'অগ্রাধিকার' => 4, 'জরুরি কি' => 4,
                         'কোনদিকে নজর' => 4, 'কি করব' => 4, 'সবচেয়ে জরুরি' => 4],
                'bl' => ['ki kora uchit' => 5, 'ki korbo' => 4, 'kon ta age' => 4, 'joruri ki' => 4],
            ],
            'approvals' => [
                'en' => ['approval' => 4, 'approvals' => 4, 'approve' => 3, 'waiting for me' => 4, 'waiting on me' => 4,
                         ...
                         'need my ok' => 3, 'authorisation' => 3, 'authorization' => 3],
            ...
            'risks' => [
                'en' => ['what am i missing' => 5, 'what is wrong' => 4, 'risk' => 3, 'risks' => 3, 'problem' => 3,
                         ...
                         'blind spot' => 4, 'anything bad' => 3, 'concerns' => 3, 'what should worry me' => 5],
            ...
            'anomalies' => [
                'en' => ['anomaly' => 5, 'anomalies' => 5, 'unusual' => 4, 'suspicious' => 4, 'irregular' => 4,
                         ...
                         'something off' => 4, 'out of the ordinary' => 4],
            ...
            'cash' => [
                'en' => ['cash' => 4, 'cash position' => 5, 'cash in hand' => 5, 'liquidity' => 4, 'how much money' => 4,
                         ...
                         'how much do we have' => 4],
                'bn' => ['ক্যাশ' => 4, 'নগদ' => 4, 'ক্যাশ কত' => 5, 'হাতে কত' => 5, 'টাকা কত আছে' => 5,
                         'তহবিল' => 3, 'নগদ অর্থ' => 4, 'কত টাকা আছে' => 5, 'হাতে টাকা' => 5],
            ...
            'bank_accounts' => [
                'en' => ['bank account' => 5, 'bank accounts' => 5, 'which bank' => 4, 'bank wise' => 5,
                         'bank balance' => 5, 'balance by bank' => 5, 'our banks' => 4, 'bank statement' => 4],
                'bn' => ['ব্যাংক অ্যাকাউন্ট' => 5, 'কোন ব্যাংকে' => 5, 'ব্যাংক ব্যালেন্স' => 5, 'ব্যাংকে কত' => 5,
                         'ব্যাংক অনুযায়ী' => 5, 'ব্যাংক হিসাব' => 4],
                'bl' => ['bank e koto' => 5, 'kon bank' => 4, 'bank balance' => 5],
            ],
            'petty_cash' => [
                'en' => ['petty cash' => 5, 'float' => 3, 'custodian' => 4, 'office cash' => 4, 'cash box' => 4],
                'bn' => ['পেটি ক্যাশ' => 5, 'খুচরা নগদ' => 5, 'অফিস ক্যাশ' => 4, 'হাতখরচ' => 3],
                'bl' => ['petty cash' => 5, 'office cash' => 4],
            ],
            'burn_runway' => [
                'en' => ['burn rate' => 5, 'runway' => 5, 'how long will cash last' => 5, 'months of cash' => 5,
                         'cash flow' => 4, 'cashflow' => 4, 'survive' => 3, 'run out of money' => 5],
                'bn' => ['টাকা কতদিন' => 5, 'কতদিন চলবে' => 5, 'নগদ প্রবাহ' => 4, 'ব্যয়ের হার' => 4,
                         'টাকা শেষ' => 4],
                'bl' => ['koto din cholbe' => 5, 'taka koto din' => 5, 'cash flow' => 4],
            ],
            ...
            'profit_loss' => [
                ...
                'bn' => ['লাভ' => 5, 'মুনাফা' => 5, 'লোকসান' => 5, 'লাভ কত' => 6, 'আয় ব্যয়' => 5,
                         'লাভ লোকসান' => 6, 'নিট মুনাফা' => 6, 'কত লাভ' => 6],
            ...
            'expenses' => [
                'en' => ['expense' => 4, 'expenses' => 4, 'spending' => 4, 'how much spent' => 5, 'cost' => 3,
                         'costs' => 3, 'outgoing' => 3, 'spend' => 3, 'expenditure' => 5],
                'bn' => ['খরচ' => 5, 'ব্যয়' => 5, 'খরচ কত' => 6, 'কত খরচ' => 6, 'ব্যয় কত' => 6],
                'bl' => ['khoroch' => 5, 'khoroch koto' => 6, 'kharoch' => 5, 'beye' => 3],
            ],
            'expense_by_category' => [
                'en' => ['by category' => 5, 'biggest expense' => 5, 'where is the money going' => 5,
            ...
            'account_ledger' => [
                'en' => ['ledger' => 5, 'account ledger' => 6, 'statement of account' => 5, 'account code' => 5,
                         'chart of accounts' => 5, 'account balance' => 4, 'gl' => 3, 'general ledger' => 6],
                'bn' => ['খতিয়ান' => 6, 'লেজার' => 5, 'হিসাব বিবরণী' => 5, 'হিসাব কোড' => 5, 'সাধারণ খতিয়ান' => 6],
                'bl' => ['ledger' => 5, 'khotian' => 6, 'hisab code' => 5],
            ],
            'journal' => [
            ...
            'tax' => [
                ...
                'bn' => ['ভ্যাট' => 5, 'কর' => 4, 'ট্যাক্স' => 5, 'উৎসে কর' => 6, 'আয়কর' => 5, 'মূসক' => 6],
                'bl' => ['vat' => 5, 'tax' => 4, 'kor' => 3],
            ],
            'company_compare' => [
                'en' => ['which company' => 5, 'compare companies' => 6, 'company wise' => 6, 'by company' => 5,
                         'best performing company' => 6, 'worst company' => 5, 'across companies' => 5],
                'bn' => ['কোন কোম্পানি' => 5, 'কোম্পানি অনুযায়ী' => 6, 'কোম্পানি ভিত্তিক' => 6,
                         'সেরা কোম্পানি' => 6, 'কোন প্রতিষ্ঠান' => 5],
            ...
            'payroll' => [
                ...
                'bn' => ['বেতন' => 5, 'পে-রোল' => 6, 'পেরোল' => 6, 'বেতন বিল' => 6, 'পে স্লিপ' => 5,
                         'পেস্লিপ' => 5, 'বেতন ভাতা' => 5, 'মজুরি' => 4],
            ...
            'deduction_rules' => [
                'en' => ['how is late deduction' => 6, 'deduction calculated' => 6, 'deduction rule' => 6,
                         ...
                         'late rule' => 5, 'absent deduction' => 5, 'how is salary calculated' => 6],
                'bn' => ['কর্তন কিভাবে' => 6, 'বিলম্ব কর্তন' => 6, 'কর্তনের নিয়ম' => 6, 'কিভাবে হিসাব' => 5,
                         'কেন কাটা হলো' => 5, 'বেতন কিভাবে হিসাব' => 6],
                'bl' => ['deduction kivabe' => 6, 'kata hoyeche keno' => 5, 'niyom ki' => 4],
            ],
            'overtime' => [
            ...
            'headcount' => [
                ...
                'bn' => ['কতজন কর্মী' => 6, 'কতজন+কর্মী' => 6, 'কত+কর্মচারী' => 6, 'জনবল' => 6, 'কত কর্মচারী' => 6, 'মোট কর্মী' => 6, 'কতজন আছে' => 5,
                         'লোকবল' => 5],
            ...
            'attendance_today' => [
                ...
                'bn' => ['হাজিরা' => 6, 'আজ কে অনুপস্থিত' => 6, 'কে অনুপস্থিত' => 6, 'কে উপস্থিত' => 6,
                         'আজ কে এসেছে' => 6, 'উপস্থিতি' => 6, 'কে আসেনি' => 6],
                'bl' => ['aj ke onupostit' => 6, 'hajira' => 6, 'ke aseni' => 6, 'ke eseche' => 5],
            ],
            'late_today' => [
                'en' => ['who came late' => 6, 'late today' => 6, 'latecomers' => 6, 'who was late' => 6,
                         'late arrival' => 6],
                'bn' => ['কে দেরি করে এসেছে' => 6, 'আজ কে লেট' => 6, 'দেরিতে এসেছে' => 6, 'বিলম্বে এসেছে' => 6],
                'bl' => ['ke deri korlo' => 6, 'ke late' => 6, 'deri kore eseche' => 6],
            ],
            'chronic_late' => [
                'en' => ['always late' => 6, 'chronic late' => 6, 'habitual' => 5, 'punctuality' => 6,
                         'late pattern' => 6, 'repeatedly late' => 6, 'worst attendance' => 5],
                'bn' => ['প্রায়ই দেরি' => 6, 'নিয়মিত দেরি' => 6, 'সময়ানুবর্তিতা' => 6, 'বারবার লেট' => 6],
                'bl' => ['baar baar late' => 6, 'niyomito deri' => 6],
            ],
            'leaves' => [
            ...
            'holidays' => [
                'en' => ['holiday' => 4, 'holidays' => 5, 'next holiday' => 6, 'public holiday' => 6,
                         'office closed' => 5, 'weekend' => 3],
                'bn' => ['সরকারি ছুটি' => 6, 'ছুটির দিন' => 6, 'পরবর্তী ছুটি' => 6, 'অফিস বন্ধ' => 5],
                'bl' => ['sorkari chuti' => 6, 'porer chuti' => 6],
            ],
            'employee_requests' => [
                'en' => ['employee request' => 6, 'staff request' => 6, 'loan request' => 6, 'request pending' => 5,
                         'application from' => 4],
                'bn' => ['কর্মচারীর আবেদন' => 6, 'কর্মীর আবেদন' => 6, 'আবেদন অপেক্ষমাণ' => 5, 'ঋণের আবেদন' => 6],
                'bl' => ['kormir abedon' => 6, 'request pending' => 5],
            ],
            'evaluate_person' => [
                'en' => ['how is performing' => 6, 'evaluate' => 5, 'performance of' => 6, 'tell me about' => 4,
            ...
            'todos' => [
                'en' => ['office todo' => 6, 'checklist' => 5, 'todo list' => 5],
                'bn' => ['অফিস কাজের তালিকা' => 6, 'চেকলিস্ট' => 5, 'করণীয় তালিকা' => 6],
            ...
            'pipeline' => [
                'en' => ['pipeline' => 6, 'lead' => 4, 'leads' => 5, 'prospect' => 5, 'crm' => 5, 'conversion' => 5,
                         'follow up' => 5, 'deal' => 4, 'deals' => 4, 'sales funnel' => 6, 'opportunity' => 4],
            ...
            'howto' => [
                'en' => ['how does it work' => 6, 'how does the' => 5, 'explain' => 4, 'what does it mean' => 5,
                         'what is the rule' => 6, 'why does' => 4, 'how is it posted' => 6, 'workflow' => 5,
                         'what happens when' => 6, 'process for' => 5],
                'bn' => ['কিভাবে কাজ করে' => 6, 'বুঝিয়ে বলো' => 6, 'মানে কি' => 5, 'নিয়ম কি' => 6,
                         'কি হয় যখন' => 5, 'প্রক্রিয়া' => 5],
                'bl' => ['kivabe kaj kore' => 6, 'bujhiye bolo' => 6, 'mane ki' => 5, 'niyom' => 4],
            ],
            'capabilities' => [
                'en' => ['what can you do' => 6, 'help me' => 4, 'what do you know' => 6, 'your abilities' => 6,
                         'what can i ask' => 6, 'options' => 3, 'commands' => 4],
                'bn' => ['তুমি কি পারো' => 6, 'কি কি পারো' => 6, 'সাহায্য' => 4, 'কি জিজ্ঞেস করতে পারি' => 6],
                'bl' => ['tumi ki paro' => 6, 'ki ki paro' => 6, 'help' => 3],
            ],
            'greeting' => [
