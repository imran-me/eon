...
export function brief(D, { company = null, name = null } = {}) {
  ...
  const who = name || (D.meta && D.meta.boss && D.meta.boss.name && D.meta.boss.name.split(' ').slice(-1)[0]) || 'Boss';
...
export const EonErpDecisions = { kpis, approvals, all, brief, LAYERS, SEVERITY };
