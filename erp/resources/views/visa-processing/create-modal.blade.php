    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl z-10 flex flex-col max-h-[92vh]">
        ...
        <div class="flex items-center justify-between px-6 py-4 bg-blue-600 rounded-t-2xl flex-shrink-0">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-base font-bold text-white">New Visa Application</h3>
                    <p class="text-xs text-blue-100">Fill in all required fields to create an application</p>
                </div>
            </div>
        ...
        <div class="overflow-y-auto flex-1 min-h-0">
            <form id="createForm"
                action="{{ route('role.visa.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}"
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-6 h-6 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0">
                                <i class="fas fa-globe text-blue-600 text-[10px]"></i>
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2">
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Application ID</label>
                                <input type="text" readonly value="{{ $nextApplicationId }}"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-100 text-gray-400 font-mono">
                            </div>
                            {{-- Country --}}
                            <div>
                                ...
                                <select id="create_country_id" name="country_id"
                                    class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 select2"
                                    style="width:100%">
                            ...
                            <div>
                                ...
                                <select id="create_visa_category_id" name="visa_category_id"
                                    class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 select2"
                                    style="width:100%">
                            ...
                            <div>
                                ...
                                <input type="text" id="c_visa_type_display" readonly placeholder="Auto-filled from category"
                            ...
                            <div>
                                ...
                                <input type="text" id="c_avg_processing_days_display" readonly placeholder="—"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-100 text-gray-500">
                            </div>
                            {{-- Duration --}}
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Duration of Stay</label>
                                <input type="text" name="duration" id="c_duration" placeholder="e.g. 30 days, 1 year"
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <div class="flex-1">
                                    <select id="create_passport_holder_id" name="passport_holder_id"
                                        class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 select2 vp-ph-select"
                                        style="width:100%">
                                ...
                                <button type="button" onclick="openVpPhModal('create_passport_holder_id')"
                                    class="vp-ph-add-btn inline-flex items-center gap-1.5 px-3 py-2.5 text-xs font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition whitespace-nowrap flex-shrink-0">
                                    <i class="fas fa-plus text-[10px]"></i> New
                                </button>
                            </div>

                            {{-- Holder Info Card --}}
                            <div id="c_holder_info" class="hidden mt-2">
                                <div class="p-3 bg-blue-50 border border-blue-100 rounded-xl grid grid-cols-3 gap-3 text-xs text-blue-800">
                                    <div><span class="font-semibold block text-blue-500 mb-0.5">Passport No</span><span id="c_holder_passport" class="font-mono">—</span></div>
                                    <div><span class="font-semibold block text-blue-500 mb-0.5">Phone</span><span id="c_holder_phone">—</span></div>
                                    <div><span class="font-semibold block text-blue-500 mb-0.5">Nationality</span><span id="c_holder_nationality">—</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="costing_price" id="c_costing_price"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 transition"
                                    placeholder="0" oninput="calcCreateTotal()">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Vendor (payable to)</label>
                                <select name="vendor_id" id="c_vendor_id" onchange="visaOnVendorChange(this)"
                                    class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 select2"
                                    style="width:100%">
                            ...
                            <div>
                                ...
                                <select name="portal_id" id="c_portal_id" onchange="visaOnPortalChange(this)"
                                    class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 select2"
                                    style="width:100%">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="sale_price" id="c_sale_price"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 transition"
                                    placeholder="0" oninput="calcCreateTotal()">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Advance Received (৳)</label>
                                <input type="number" step="0.01" min="0" name="advance_received" id="c_advance"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 transition"
                                    placeholder="0" oninput="calcCreateTotal()">
                            </div>
                            <div>
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-6 h-6 rounded-lg bg-violet-100 flex items-center justify-center flex-shrink-0">
                                <i class="fas fa-calendar-check text-violet-600 text-[10px]"></i>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <textarea id="create_remarks" name="remarks" rows="3"
                            ...
                            <div>
                                ...
                                <div id="create_attachments_wrapper" class="space-y-2"></div>
                                <button type="button" id="create_add_attachment"
                                    class="mt-2 inline-flex items-center gap-1.5 text-xs text-blue-600 hover:text-blue-700 font-medium transition">
        ...
        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl flex-shrink-0">
            ...
            <button id="createSubmit" type="button"
                ...
                <i class="fas fa-save text-xs"></i> Create Application
            </button>
        </div>
...
function calcCreateTotal() {
    const sale    = parseFloat(document.getElementById('c_sale_price')?.value) || 0;
    const advance = parseFloat(document.getElementById('c_advance')?.value)    || 0;
    const due     = Math.max(0, sale - advance);
    document.getElementById('c_due').value = '৳ ' + due.toLocaleString('en-BD', { minimumFractionDigits: 0 });
}
</script>
