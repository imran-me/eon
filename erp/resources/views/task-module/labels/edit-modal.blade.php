        ...
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="modal-body mt-4">
                <form id="editeForm" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="edit_project_id" class="block text-gray-700 text-sm font-semibold mb-2">Project<span class="text-red-500">*</span>
                        </label>
                        <select id="edit_project_id" name="project_id" class="form-select w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="edit_name" name="name" placeholder="Enter label name"
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-semibold mb-3">Label Color</label>
                        <input type="hidden" name="color" id="edit_color" value="blue">
                        <div class="grid grid-cols-5 gap-3">
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="gray" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="blue" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="purple" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="green" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="yellow" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="red" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="indigo" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="pink" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="orange" class="hidden color-radio-edit">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color_preset" value="teal" class="hidden color-radio-edit">
                        ...
                        <div class="mt-3 flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                            <label for="edit_custom_color" class="text-sm font-semibold text-gray-700">Custom Color</label>
                            <input type="color" id="edit_custom_color" value="#3b82f6" class="custom-color-picker-edit" style="width:42px;height:32px;border:1px solid #e5e7eb;border-radius:6px;padding:2px;cursor:pointer;">
                            <span id="edit_custom_color_value" class="text-xs font-mono text-gray-500">#3b82f6</span>
                        </div>
                        <p class="text-gray-500 text-xs mt-2">Select a preset or pick a custom color for this label</p>
                    </div>
                </form>
            </div>
            <div class="modal-footer flex justify-end pt-4">
                ...
                <button data-action="{{ route('role.labels.update', ['role' => Str::slug(Auth::user()->getRoleNames()->first()), 'label' => 1]) }}" id="editSubmit" type="button" class="btn btn-primary px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-200 shadow">
                    Update
                </button>
            </div>
        </div>
