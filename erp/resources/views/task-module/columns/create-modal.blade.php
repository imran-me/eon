    ...
    <div class="modal-container bg-white w-11/12 mx-auto rounded shadow-lg z-50 overflow-y-auto" style="max-width: 700px; max-height: 90vh;">
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="modal-body mt-4">
                <form id="createForm" action="{{ route('role.columns.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}" method="POST">
                    @csrf
                    {{-- <div class="mb-4">
                        <label for="board_id" class="block text-gray-700 text-sm font-semibold mb-2">Select Board<span class="text-red-500">*</span>
                        </label>
                        <select id="board_id" name="board_id" class="form-select select2 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" style="width: 100%">
                            <option value="">Select board</option>
                            @foreach($boards as $board)
                                <option value="{{ $board->id }}">{{ $board->name }}</option>
                            @endforeach
                        </select>
                        <p class="text-red-500 text-xs mt-1 hidden error-message">Please choose a board</p>
                    </div> --}}
                    <div class="mb-4">
                        <label for="name" class="block text-gray-700 text-sm font-semibold mb-2">Name<span class="text-red-500">*</span>
                        </label>
                        <input type="text" id="name" name="name" placeholder="Enter column name"
                    ...
                    <div class="mb-4">
                        <label for="position" class="block text-gray-700 text-sm font-semibold mb-2">Position <span class="text-gray-500 text-xs font-normal">(Optional - auto-calculated if empty)</span></label>
                        <input type="number" id="position" name="position" placeholder="Leave empty for auto-position" min="0"
                        class="form-input w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-5 gap-3">
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="gray" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="blue" class="hidden color-radio" checked>
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="purple" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="green" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="yellow" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="red" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="indigo" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="pink" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="orange" class="hidden color-radio">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="teal" class="hidden color-radio">
                        ...
                        <p class="text-gray-500 text-xs mt-2">Blue is selected by default</p>
                    </div>
                </form>
            </div>
