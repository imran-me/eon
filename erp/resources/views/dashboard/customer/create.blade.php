...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Epal Group ERP &rsaquo; Customer Management &rsaquo; Add Customer</p>
        </div>
    ...
    <form action="{{ route('role.customer.store', ['role' => Str::slug(Auth::user()->getRoleNames()->first())]) }}"
          method="POST">
        @csrf
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="address" id="address" rows="3"
                                      ...
                                      class="w-full px-4 py-2.5 text-sm rounded-lg border focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition resize-none {{ $errors->has('address') ? 'border-red-400 bg-red-50' : 'border-gray-200' }}">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="text-xs text-red-600 mt-1.5">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="space-y-5">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-6">
                    <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100">
                        ...
                        <h2 class="text-sm font-semibold text-gray-700">Save Customer</h2>
                    </div>
                    <div class="p-6 space-y-4">
                        <p class="text-xs text-gray-500 leading-relaxed">
                            Review the information before saving. The customer will be created with
