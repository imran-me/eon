                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" onblur="calculateGrandTotal()" step="0.01" value="0.00" id="paid_amount" name="paid_amount" class="form-input w-full pl-8 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="0.00" style="background: white">
                                            </div>
                                            <small style="color: green">Previously Paid: <span class="paid_amount">{{ $purchase->paid_amount }}</span></small>
                                        </div>
...
@section('js')
    ...
    <script>
        ...
        function calculateGrandTotal() {
            ...
            let previouslyPaid = parseFloat($('.paid_amount').text() || 0);
            paidAmount = paidAmount + previouslyPaid;
