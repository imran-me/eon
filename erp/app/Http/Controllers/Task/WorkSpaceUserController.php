...
class WorkSpaceUserController implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            new Middleware('permission:view workspace'),
            new Middleware('permission:create workspace', only: ['store']),
            new Middleware('permission:edit workspace', only: ['update']),
            new Middleware('permission:delete workspace', only: ['destroy']),
        ];
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('task-module.workspace-user.index', compact(
            'datas',
            'companies',
            'allUsers',
            'projects',
    ...
    {
        try {
            $data = WorkspaceUser::find($request->item_id);
            if ($data) {
                $data->delete();
            } else {
                return response()->json([
