...
class CommissionController implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            new Middleware('permission:view commission', only: ['index']),
            new Middleware('permission:create commission', only: ['create', 'store']),
            new Middleware('permission:edit commission', only: ['edit', 'update']),
            new Middleware('permission:delete commission', only: ['destroy']),
        ];
    }
    /**
