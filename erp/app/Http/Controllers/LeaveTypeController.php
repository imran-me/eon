...
class LeaveTypeController implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            new Middleware('permission:view leave type', only: ['index']),
            new Middleware('permission:create leave type', only: ['create', 'store']),
            new Middleware('permission:edit leave type', only: ['edit', 'update']),
